 ...
 *
 * 오늘 이 연결로 옮겨온 것은 `./idempotency.js`(조각 1/4) · `./credential.js`(조각 1/4) ·
 * `./store.js`(조각 2/4, mori-nest #131) · `./workspace-store.js`(조각 3/4, mori-nest #132)
 * 넷 전부다. 라우트를 한 트랜잭션으로 묶어 실패 창을 실제로 닫는 것만 **조각 4/4**로 남았다.
 *
 * ## 한 앱 두 포트로도, 두 앱으로도
 *
